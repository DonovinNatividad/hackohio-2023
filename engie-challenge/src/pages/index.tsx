...
import { DonutChart, Title, Legend, Divider, Text, Tracker, type Color, Flex, BadgeDelta, BarChart, Subtitle } from "@tremor/react";
  ...
  const chartdata = [
    {
      ...
      "Kilolitres of water used": 2488,
    },
    {
      name: "Traditions at Kennedy",
      "Kilolitres of water used": 1445,
    },
    {
      name: "Traditions at Morrill",
      "Kilolitres of water used": 743,
    },
    {
      name: "Oval Lawn",
      "Kilolitres of water used": 281,
    },
  ];
  ...
  return (
    <>
      <div className={darkMode ? "dark" : ""}>
        <Head>
          <title>Energizing Change: Ohio State's Sustainable Path Forward</title>
      ...
      <header className="sticky top-0 bg-stone-50 dark:bg-stone-900"> 
        ...
        <p className="text-slate-100 text-6xl m-20 mb-28 mt-28 align-text-bottom">Energizing Change: Ohio State's Sustainable Path Forward!</p>
          ...
          <div className="container mx-auto mt-16 p-4 ">
                  <Title>Water usage of places across campus, October 29th, 2023 </Title>
            <Subtitle>
            ...
            <BarChart
              ...
              data={chartdata}
              index="name"
              categories={["Kilolitres of water used"]}
              colors={["blue"]}
